...
//if(MessageBox(hwnd,_T("Вы уверены?"),_T("Да/Нет"),MB_YESNO|MB_ICONQUESTION) == IDYES)
//if(hwnd,MessageBox((LPSTR)"Вы уверены?",(LPSTR)"Да/Нет",MB_YESNO|MB_ICONQUESTION) == IDYES)
